...
epiplot(Fatalities, x=Fatalities$service, y=Fatalities$income, graph = "barsgroup", fill = Fatalities$breath) 

 ggplot(Fatalities, aes(fill=breath, y=income, x=service)) +
