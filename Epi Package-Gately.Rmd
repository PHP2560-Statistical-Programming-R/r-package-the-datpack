...
plot_usmap(
  ...
  scale_fill_continuous(
    low = "white", high = "blue", name = "fatalities", label = scales::comma
  ) + 
...
```{r}
plot_usmap(
    data = Fatalities, values = "fatal", include = c("MT","WY","CO","NM","AZ","UT","CA", "ID", "NV", "OR", "WA","AK","HI"), lines = "red"
  ) + 
  scale_fill_continuous(
    low = "white", high = "orange", name = "Fatalities", label = scales::comma
  ) + 
