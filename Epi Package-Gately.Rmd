...
#Region Function (Not Working)
```{r}
map_region_prevalence <- function(data,existing_cases,population,geographic_region) {
us_map <- map_data("state")
...
map_region_prevalence(Fatalities_clean,existing_cases= "fatal", population="pop", geographic_region = "Northeast")
```
